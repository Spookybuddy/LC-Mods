    ...
    public class SyncedInstance<T>
    {
        ...
        public static byte[] SerializeToBytes(T val)
        {
            ...
            try {
                ...
                STFixModBase.mls.LogError($"Error serializing instance: {e}");
                return null;
            }
        }
        ...
        public static T DeserializeFromBytes(byte[] data)
        {
            ...
            try {
                ...
                STFixModBase.mls.LogError($"Error deserializing instance: {e}");
                return default;
            }
        }
        ...
        public static void OnRequestSync(ulong clientId, FastBufferReader _)
        {
            ...
            STFixModBase.mls.LogInfo($"Config sync request received from client: {clientId}");
            ...
            try {
                ...
                STFixModBase.mls.LogInfo($"Error occurred syncing config with client: {clientId}\n{e}");
            }
        }
        ...
        public static void OnReceiveSync(ulong _, FastBufferReader reader)
        {
            if (!reader.TryBeginRead(IntSize)) {
                STFixModBase.mls.LogError("Config sync error: Could not begin reading buffer.");
                return;
            }

            reader.ReadValueSafe(out int val, default);
            if (!reader.TryBeginRead(val)) {
                STFixModBase.mls.LogError("Config sync error: Host could not sync.");
                return;
            }
            ...
            STFixModBase.mls.LogInfo("Successfully synced config with host.");
        }
