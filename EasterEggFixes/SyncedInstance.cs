    ...
    public class SyncedInstance<T>
    {
        ...
        public static byte[] SerializeToBytes(T val)
        {
            ...
            try {
                ...
                EasterEggFixesModBase.mls.LogError($"Error serializing instance: {e}");
                return null;
            }
        }
        ...
        public static T DeserializeFromBytes(byte[] data)
        {
            ...
            try {
                ...
                EasterEggFixesModBase.mls.LogError($"Error deserializing instance: {e}");
                return default;
            }
        }
        ...
        public static void OnRequestSync(ulong clientId, FastBufferReader _)
        {
            ...
            EasterEggFixesModBase.mls.LogInfo($"Config sync request received from client: {clientId}");
        ...
        public static void OnReceiveSync(ulong _, FastBufferReader reader)
        {
            if (!reader.TryBeginRead(IntSize)) {
                EasterEggFixesModBase.mls.LogError("Config sync error: Could not begin reading buffer.");
                return;
            }

            reader.ReadValueSafe(out int val, default);
            if (!reader.TryBeginRead(val)) {
                EasterEggFixesModBase.mls.LogError("Config sync error: Host could not sync.");
                return;
            }
            ...
            EasterEggFixesModBase.mls.LogInfo("Successfully synced config with host.");
        }
